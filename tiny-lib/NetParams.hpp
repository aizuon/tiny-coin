...
public:
	...
	static constexpr uint64_t MAX_FUTURE_BLOCK_TIME_IN_SECS = 60 * 60 * 2;
	...
	static constexpr uint64_t DIFFICULTY_PERIOD_IN_BLOCKS = DIFFICULTY_PERIOD_IN_SECS_TARGET / TIME_BETWEEN_BLOCKS_IN_SECS_TARGET;
	static constexpr uint8_t INITIAL_DIFFICULTY_BITS = 24;
	static constexpr uint16_t HALVE_SUBSIDY_AFTER_BLOCKS_NUM = 21000;
};