...
public:
	...
	static constexpr uint32_t TIME_BETWEEN_BLOCKS_IN_SECS_TARGET = 1 * 60;
	static constexpr uint32_t DIFFICULTY_PERIOD_IN_SECS_TARGET = 60 * 60 * 10;
	static constexpr uint32_t DIFFICULTY_PERIOD_IN_BLOCKS = DIFFICULTY_PERIOD_IN_SECS_TARGET / TIME_BETWEEN_BLOCKS_IN_SECS_TARGET;
	static constexpr uint8_t INITIAL_DIFFICULTY_BITS = 24;
	static constexpr uint32_t HALVE_SUBSIDY_AFTER_BLOCKS_NUM = 21000;
};